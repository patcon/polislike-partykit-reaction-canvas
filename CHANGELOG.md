...
### Added
- V2: presence counter now shows "X here · Y touching ▶️/⏸️" — participant count, active touching count (others + self), and a play/pause emoji reflecting whether the video is currently playing
