...
export type ActivityMode = 'canvas' | 'soccer' | 'image-canvas' | 'social-media' | 'mood-tones' | 'treevites' | 'greeter' | 'signature' | 'steno' | 'story-tracer' | 'voice-call' | 'map-maker' | 'map-viewer';
